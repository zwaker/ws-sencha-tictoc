...
/**
 * The persistent class for the TTUSER_REQUEST_SENT database table.
 * 
 */
@Entity
@Table(name="TTUSER_REQUEST_SENT")
public class TtuserRequestSent implements Serializable {
